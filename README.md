...
```bash
python qcmdp_single_mg_training.py --data-path /path/to/your/data.csv
```

Optional configuration override:

```bash
python qcmdp_single_mg_training.py --data-path /path/to/your/data.csv --config-json experiment_config.template.json
```
...
```bash
python ring_federated_qcmdp_training.py --data-path /path/to/your/data.csv
```
...
set RING_ALPHA=0.2
python ring_federated_qcmdp_training.py --data-path C:\path\to\your\data.csv
```
